...
exports.answerController = {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        answers = _a.sent();
                        return [2 /*return*/, res.json(answers)];
                    case 2:
                        error_1 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        answer = _a.sent();
                        return [2 /*return*/, res.json({ answer: answer })];
                    case 3:
                        error_2 = _a.sent();
    ...
    getAnswerById: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var paramId, uniqueAnswer, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        uniqueAnswer = _a.sent();
                        return [2 /*return*/, res.json({ uniqueAnswer: uniqueAnswer })];
                    case 3:
                        error_3 = _a.sent();
    ...
    answerAnUnansweredQuestion: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var answerData, answer, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        answerData = req.body;
